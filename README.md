...
> arXiv: **[TO FILL AFTER POSTING]**

It contains, byte for byte, the ancillary directory `anc/` of the arXiv
...
Cite the paper (title and author above; arXiv id to be filled after
